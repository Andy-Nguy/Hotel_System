...
<body>
                        ...
                        <div class="card-body">
                            <div class="d-flex mb-3 align-items-center">
                                ...
                                <div class="me-2 d-flex align-items-center" style="min-width:220px">
                                    ...
                                    <input type="text" id="filter-q" class="form-control form-control-sm" placeholder="Mã đặt / Tên phòng" />
                                </div>
    ...
    (function(){
        ...
        function renderTable(data){
            ...
            rows.forEach(r => {
                ...
                bindRowButtons(tr, r);
                // hide invoice button if an invoice already exists for this booking
                (function(rowEl, rec){
                    // fire-and-forget async check
                    checkInvoiceExists(rec.IDDatPhong).then(has => {
                        if (has) {
                            const b = rowEl.querySelector('.btn-invoice');
                            if (b) b.remove();
                        }
                    }).catch(e => { /* ignore */ });
                })(tr, r);
        ...
        function actionButtonsHtml(r){
            ...
            if (String(r.TrangThai) !== '0' && String(r.TrangThai) !== '2') html += '<button class="btn btn-sm btn-danger btn-cancel" data-id="'+escapeHtml(r.IDDatPhong)+'">Hủy</button>';
            if (String(r.TrangThai) === '2') html += '<button class="btn btn-sm btn-primary btn-invoice" data-id="'+escapeHtml(r.IDDatPhong)+'">Tạo hóa đơn</button>';
            return html;
        }
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-6 text-end">Thanh toán ngay: <input id="inv-paid-now" type="number" min="0" step="1000" class="form-control form-control-sm d-inline-block" style="width:160px" value="0" /></div>
                        </div>
                        ...
                        <div id="inv-services-area" style="display:none">
                            <div class="table-responsive mb-2">
                                <table class="table table-sm table-bordered" id="inv-services-table">
                                    <thead>
                                        <tr>
                                            <th>Dịch vụ</th>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="inv-save" disabled>Lưu hóa đơn</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    async function openInvoiceModal(bookingId, attempt = 0){
            ...
            try {
                const r2 = await fetch('/api/dichvu');
