...
<script>
    ...
    async function handleConfirmDeleteDichVu() {
        ...
        const modalEl = document.getElementById('modalDeleteDichVu');
        try {
            ...
            if (res && res.success) {
                ...
                showAlert('danger', res?.message || 'Không thể xóa dịch vụ.');
                console.warn('Delete service failed', res);
            }
        } catch (e) {
            showAlert('danger', e.message || 'Không thể xóa dịch vụ.');
            console.error(e);
        } finally {
            try { MODAL_DELETE_DICHVU.hide(); } catch (ignore) {}
        }
    }
    ...
    async function handleConfirmDeleteChiTiet() {
        ...
        try {
            ...
            if (res && res.success) {
                ...
                showAlert('danger', res?.message || 'Không thể xóa chi tiết.');
                console.warn('Delete detail failed', res);
            }
        } catch (e) {
            showAlert('danger', e.message || 'Không thể xóa chi tiết.');
            console.error(e);
        } finally {
            try { MODAL_DELETE_CHITIET.hide(); } catch (ignore) {}
        }
    }
