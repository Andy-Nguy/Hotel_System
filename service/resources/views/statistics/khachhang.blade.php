        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="d-flex mb-3 align-items-center">
                    <input id="kh-search" type="text" class="form-control me-2"
                        placeholder="Tìm theo tên, email hoặc số điện thoại" style="max-width:800px;" />
...
@section('scripts')
    ...
    <script>
        (function() {
                        ...
                        fetch('/api/register-with-account', {
                                ...
                                body: JSON.stringify({
                                    HoTen: document.querySelector(
                                        'input[name="HoTen"]').value || 'Khách hàng',
                                    Email: email,
                                    MatKhau: '123456',
                                    SoDienThoai: document.querySelector(
                                            'input[name="SoDienThoai"]').value ||
                                        '',
                                    NgaySinh: document.querySelector(
                                            'input[name="NgaySinh"]').value ||
                                        ''
                                })
                            })
            ...
            addClose && addClose.addEventListener('click', function() {
                closeModal(addModal);
            });
            addCancel && addCancel.addEventListener('click', function() {
                closeModal(addModal);
            });
            ...
            editClose && editClose.addEventListener('click', function() {
                closeModal(editModal);
            });
            editCancel && editCancel.addEventListener('click', function() {
                closeModal(editModal);
            });
