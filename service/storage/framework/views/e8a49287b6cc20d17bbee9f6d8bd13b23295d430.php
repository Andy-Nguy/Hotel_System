...
<body>
        ...
        <div class="main-container">
            ...
            <div class="app-container">
                ...
                <div class="app-body p-3">
                    <form id="hoadon-filter-form" method="GET" action="<?php echo e(route('hoadon.index')); ?>">
                        <div class="row g-3 align-items-end filter-controls">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="status" class="form-select">
                                    ...
                                    <option value="0" <?php echo e(request()->get('status', '2') === '0' ? 'selected' : ''); ?>>Tất cả</option>
                                    <option value="1" <?php echo e(request()->get('status', '2') == '1' ? 'selected' : ''); ?>>Chưa thanh toán</option>
                                    <option value="2" <?php echo e(request()->get('status', '2') == '2' ? 'selected' : ''); ?>>Đã thanh toán</option>
                                </select>
                            </div>
                            <div class="col-md-6">
    ...
    </html><?php /**PATH I:\Ky_06_2025_2026\php\New folder\Hotel_System\service\resources\views/statistics/hoadon.blade.php ENDPATH**/ ?>